...
<html>
    ...
    <body>
        <div class="container site">
            ...
            <h1 class="text-logo"><span class="bi-shop"></span> Hôtel d'Ibrahima <span class="bi-shop"></span></h1>
            
            <!-- Ajout du bouton pour accéder à l'admin -->
            <div class="d-flex justify-content-end">
                <a href="admin/index.php" class="btn btn-primary">Accéder à l'admin</a>
            </div>
                        ...
                        echo '<div class="col-md-6 col-lg-4">
                                <div class="img-thumbnail">
                                    ...
                                    <div class="caption">
                                        ...
                                        <a href="#" class="btn btn-order" role="button"><span class="bi-cart-fill"></span> Réserver</a>
                                    </div>
                                </div>
                            </div>';
                    }
